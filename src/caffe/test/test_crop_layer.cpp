...
TYPED_TEST(CropLayerTest, TestCropHW) {
  typedef typename TypeParam::Dtype Dtype;
  LayerParameter layer_param;
  layer_param.mutable_crop_param()->set_axis(3);
  layer_param.mutable_crop_param()->add_offset(1);
  layer_param.mutable_crop_param()->add_offset(2);
  CropLayer<Dtype> layer(layer_param);
  layer.SetUp(this->blob_bottom_vec_, this->blob_top_vec_);
...
TYPED_TEST(CropLayerTest, TestCrop5D) {
  ...
  vector<int> bottom_0_shape;
  bottom_0_shape.push_back(2);
  bottom_0_shape.push_back(4);
  bottom_0_shape.push_back(5);
  bottom_0_shape.push_back(4);
  bottom_0_shape.push_back(2);
  vector<int> bottom_1_shape;
  bottom_1_shape.push_back(2);
  bottom_1_shape.push_back(3);
  bottom_1_shape.push_back(4);
  bottom_1_shape.push_back(2);
